...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `dongricore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ dongricore-node add wallet-service');
      console.log('    $ dongricore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ dongricore-node remove wallet-service');
      console.log('    $ dongricore-node remove insight-api');
      console.log();
    });
